...
// Q: Could you come up with a solution that has a better time complexity? 
//If so, write out that solution and note the time complexity. If not, why not?
// ANSWER:
...
// 15) Here are two functions that you came up with to count how many of \
//each letter is in a given string and return an object with the individual counts: 
